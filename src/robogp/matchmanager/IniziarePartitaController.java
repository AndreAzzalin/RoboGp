...
public class IniziarePartitaController {
     ...
     */
    private ArrayList<Pair<String, List<RobotMarker>>> playersRobots;
    private ArrayList<String> nickPlayers;
    private HashMap<String, Connection> playersConnection;
    ...
    public void addPlayersRobots(List<RobotMarker> robotList, String nickname) {
        this.playersRobots.add(new Pair<String, List<RobotMarker>>(nickname, robotList));
        this.nickPlayers.add(nickname);
    }

    public ArrayList<Pair<String, List<RobotMarker>>> getPlayersRobots() {
        return playersRobots;
    }
    ...
    public int getTotalRobotsInPlay() {
        int tot = 0;

        for (int i = 0; i < nickPlayers.size(); ++i) {
            tot += playersRobots.get(i).getValue().size();
        }

        return tot;
    }

    public ArrayList<String> getNickPlayers() {
        return nickPlayers;
    }

    public void setPlayersConnection(HashMap<String, Connection> connections) {
        playersConnection = connections;
    }

    public HashMap<String, Connection> getPlayersConnection() {
