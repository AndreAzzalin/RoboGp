...
public class Match implements MessageObserver {
    ...
    public static final String MatchListCards = "cardsList";
    public static final String MatchInstructionsList = "instructionsList";
    ...
    private final GiocarePartitaController gcrPartCtrl;
    ...
    private Match(String rbdName, int nMaxPlayers, int nRobotsXPlayer, EndGame endGameCond, boolean initUpg) {
        ...
        this.gcrPartCtrl = GiocarePartitaController.getInstance();
    ...
    public void start() {
        ...
        msg.setParameters(new Object[]{this.inizPartCtrl.getPlayersRobots(),
            this.inizPartCtrl.getRbdName()});
        
        gcrPartCtrl.setPlayersConnections(players);
