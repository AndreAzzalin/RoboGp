...
public class MatchManagerApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        parametriMatch = new javax.swing.JTextArea();
        ...
        jLabel7.setText("PANNELLO DI CONTROLLO MATCHMANAGER");

        playerList.setColumns(20);
        playerList.setRows(5);
        jScrollPane3.setViewportView(playerList);

        parametriMatch.setColumns(20);
        parametriMatch.setRows(5);
        jScrollPane4.setViewportView(parametriMatch);

        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("Giocatori in partita");

        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("Parametri partita");
        ...
        ongoingMatchPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ongoingMatchPanelLayout.createSequentialGroup()
                ...
                .addGroup(ongoingMatchPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        ongoingMatchPanelLayout.setVerticalGroup(
            ...
            .addGroup(ongoingMatchPanelLayout.createSequentialGroup()
                ...
                .addGap(67, 67, 67)
                .addGroup(ongoingMatchPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8)
                    .addComponent(jLabel9))
                .addGap(18, 18, 18)
                .addGroup(ongoingMatchPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void initButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_initButtonActionPerformed
        ...
        if (ok) {
            ...
            this.parametriMatch.append("Indizzo server: 127.0.0.1:"+num+"\n");
    ...
    private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButtonActionPerformed
        ...
        if (ok) {
            ...
            for (int i=0; i < robotPanel.length; i++) {
             ...
             this.parametriMatch.append("Robodromo scelto: "+rbdName+"\n"+"Max giocatori: "+nPl+"\n"+"Max robot per player: "+nRob+"\n");
    ...
    private void acceptRequestButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acceptRequestButtonActionPerformed
        ...
        if (this.robotChooser.getCloseStatus() == JOptionPane.OK_OPTION) {
           ...
           this.playerList.append(nickname+"\n");
            this.inizPartCtrl.addPlayersRobots(this.robotChooser.getSelection(), nickname);
    ...
    private javax.swing.JTextArea parametriMatch;
